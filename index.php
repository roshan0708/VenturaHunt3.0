     ...
     <!--Body-->
      <div class="modal-body" style="max-height:420px;position:relative;overflow-y:auto;">
        <form name="signup" action="" method="post">
          <input type="text" class="form-control" name="name" placeholder="Name" required="" style="margin: 10px 0px;">
          <input type="text" class="form-control" name="institute" placeholder="Institute/College" style="margin: 10px 0px;">
          <input type="text" class="form-control" name="username" placeholder="Username" required="" style="margin: 10px 0px;">
          <input type="password" class="form-control" name="password" placeholder="Password" required="" style="margin: 10px 0px;">
          <input type="password" class="form-control" name="cpassword" placeholder="Confirm Password" required="" style="margin: 10px 0px;">
          <input type="text" class="form-control" name="contact" placeholder="Contact No." required="" style="margin: 10px 0px;">
          <input type="text" class="form-control" name="email" placeholder="Email" required="" style="margin: 10px 0px;">
